...
export const cngStands = [
  ...
  { id: 16, name: "Baily Road CNG Stand", coords: [23.7410, 90.4072], area: "Bailey Road", type: "CNG", capacity: "Medium" },
  { id: 17, name: "Dhaka University TSC", coords: [23.7314, 90.3958], area: "Shahbagh", type: "Rickshaw", capacity: "Large" },
  { id: 18, name: "Jigatola Stand", coords: [23.7380, 90.3734], area: "Dhanmondi", type: "CNG", capacity: "Medium" },
  { id: 19, name: "Agargaon Metro Stand", coords: [23.7788, 90.3725], area: "Agargaon", type: "CNG", capacity: "Large" },
  { id: 20, name: "Bashundhara Gate", coords: [23.8200, 90.4265], area: "Bashundhara", type: "Rickshaw", capacity: "Very Large" },
  { id: 21, name: "Kuril Flyover Bottom", coords: [23.8188, 90.4204], area: "Kuril", type: "CNG", capacity: "Medium" },
  { id: 22, name: "Mohakhali Railgate", coords: [23.7770, 90.3965], area: "Mohakhali", type: "CNG", capacity: "Medium" }
];
...
export const waterloggingZones = [
  ...
  { id: 11, name: "Kakrail to Malibagh", coords: [23.7431, 90.4132], severity: "Moderate", description: "Water pools near Kakrail Mosque after 30 mins rain." },
  { id: 12, name: "Tejgaon Industrial Area", coords: [23.7663, 90.3951], severity: "Severe", description: "Heavy industrial waterlogging blocking truck movements." },
  { id: 13, name: "Green Road", coords: [23.7454, 90.3871], severity: "Severe", description: "Notorious for knee-deep water during monsoon." },
  { id: 14, name: "Badda U-Loop", coords: [23.7745, 90.4261], severity: "Moderate", description: "Drainage overflow causing slowdowns." },
  { id: 15, name: "Rampura Bridge", coords: [23.7610, 90.4206], severity: "Moderate", description: "Sludge and water mixed on the slope." },
  { id: 16, name: "Mouchak Intersection", coords: [23.7441, 90.4133], severity: "Severe", description: "Consistently floods due to poor drainage." },
  { id: 17, name: "Azimpur", coords: [23.7289, 90.3846], severity: "Moderate", description: "Water stagnates near the graveyard area." },
  { id: 18, name: "Shaymoli Square", coords: [23.7719, 90.3664], severity: "Moderate", description: "Main road floods, causing Mirpur Road jams." },
  { id: 19, name: "Uttara Sector 11", coords: [23.8762, 90.3901], severity: "Moderate", description: "Internal roads flood easily." }
];
...
export const schoolZones = [
  ...
  { id: 11, name: "Dhaka Residential Model College", coords: [23.7583, 90.3644], area: "Mohammadpur", startTime: "07:45", endTime: "14:00" },
  { id: 12, name: "St. Joseph Higher Secondary School", coords: [23.7621, 90.3687], area: "Mohammadpur", startTime: "08:00", endTime: "14:00" },
  { id: 13, name: "Mastermind English Medium", coords: [23.7505, 90.3702], area: "Dhanmondi", startTime: "07:30", endTime: "14:30" },
  { id: 14, name: "Scholastica, Dhanmondi", coords: [23.7439, 90.3725], area: "Dhanmondi", startTime: "08:00", endTime: "14:30" },
  { id: 15, name: "Maple Leaf International", coords: [23.7483, 90.3722], area: "Dhanmondi", startTime: "07:45", endTime: "14:00" },
  { id: 16, name: "Sunnydale School", coords: [23.7495, 90.3689], area: "Dhanmondi", startTime: "07:30", endTime: "14:15" },
  { id: 17, name: "YWCA Girls' High School", coords: [23.7380, 90.3801], area: "Green Road", startTime: "08:00", endTime: "13:30" },
  { id: 18, name: "Holy Cross College", coords: [23.7595, 90.3891], area: "Tejgaon", startTime: "07:30", endTime: "13:30" },
  // Farmgate / Center
  { id: 19, name: "Tejgaon Govt High School", coords: [23.7565, 90.3905], area: "Farmgate", startTime: "08:00", endTime: "14:00" },
  { id: 20, name: "Government Laboratory High School", coords: [23.7369, 90.3846], area: "Dhanmondi", startTime: "07:30", endTime: "14:00" },
  { id: 21, name: "Dhaka City College", coords: [23.7408, 90.3828], area: "Science Lab", startTime: "08:00", endTime: "14:30" },
  { id: 22, name: "BAF Shaheen College", coords: [23.7824, 90.3957], area: "Mohakhali", startTime: "07:45", endTime: "14:00" },
  { id: 23, name: "Adamjee Cantonment College", coords: [23.8055, 90.3970], area: "Cantonment", startTime: "07:30", endTime: "14:00" },
  // Mirpur
  { id: 24, name: "Monipur High School & College", coords: [23.8062, 90.3641], area: "Mirpur 2", startTime: "07:00", endTime: "16:00" },
  { id: 25, name: "Dhaka Commerce College", coords: [23.8067, 90.3546], area: "Mirpur", startTime: "08:00", endTime: "14:00" },
  { id: 26, name: "SOS Hermann Gmeiner College", coords: [23.8051, 90.3601], area: "Mirpur 13", startTime: "08:00", endTime: "14:00" },
  { id: 27, name: "Mirpur Cantonment Public", coords: [23.8115, 90.3861], area: "Cantonment", startTime: "07:30", endTime: "14:00" },
  { id: 28, name: "Scholastica, Mirpur", coords: [23.8142, 90.3649], area: "Mirpur", startTime: "07:45", endTime: "14:30" },
  // Uttara
  { id: 29, name: "Rajuk Uttara Model College", coords: [23.8647, 90.3986], area: "Uttara", startTime: "07:30", endTime: "14:30" },
  { id: 30, name: "Scholastica, Uttara", coords: [23.8765, 90.3934], area: "Uttara", startTime: "07:45", endTime: "14:30" },
  { id: 31, name: "Aga Khan School", coords: [23.8705, 90.3920], area: "Uttara", startTime: "08:00", endTime: "14:30" },
  { id: 32, name: "Milestone College", coords: [23.8732, 90.3888], area: "Uttara", startTime: "07:30", endTime: "14:00" },
  { id: 33, name: "DPS STS School", coords: [23.8821, 90.3869], area: "Uttara", startTime: "08:00", endTime: "14:30" },
  // Gulshan / Bashundhara
  { id: 34, name: "North South University", coords: [23.8151, 90.4255], area: "Bashundhara", startTime: "08:00", endTime: "18:00" },
  { id: 35, name: "BRAC University", coords: [23.7803, 90.4267], area: "Merul Badda", startTime: "08:00", endTime: "18:00" },
  { id: 36, name: "International School Dhaka", coords: [23.8105, 90.4230], area: "Bashundhara", startTime: "08:00", endTime: "14:30" },
  { id: 37, name: "Banani Bidyaniketan", coords: [23.7942, 90.4035], area: "Banani", startTime: "08:00", endTime: "14:00" },
  { id: 38, name: "Manarat Dhaka International", coords: [23.7981, 90.4217], area: "Gulshan", startTime: "07:45", endTime: "14:00" },
  // Others
  { id: 39, name: "Willes Little Flower School", coords: [23.7410, 90.4071], area: "Kakrail", startTime: "07:30", endTime: "14:00" },
  { id: 40, name: "Siddheswari Girls' College", coords: [23.7420, 90.4055], area: "Bailey Road", startTime: "08:00", endTime: "14:00" },
  { id: 41, name: "Motijheel Model School", coords: [23.7299, 90.4250], area: "Motijheel", startTime: "07:30", endTime: "14:00" },
  { id: 42, name: "Dhaka Collegiate School", coords: [23.7088, 90.4069], area: "Sadarghat", startTime: "08:00", endTime: "14:00" },
  { id: 43, name: "Bangladesh University of Engineering (BUET)", coords: [23.7266, 90.3923], area: "Palashi", startTime: "08:00", endTime: "17:00" },
  { id: 44, name: "Dhaka University Campus", coords: [23.7340, 90.3928], area: "Shahbagh", startTime: "08:00", endTime: "17:00" }
];
