...
let operations = [
  { _id: 'mock-op-1', category: 'Dispatch', action: 'Assigned Authority Unit A to Paltan spillback', status: 'In Progress', actorName: 'System Seed', details: { location: 'Paltan' }, createdAt: new Date().toISOString() },
  { _id: 'mock-op-2', category: 'Signal', action: 'Applied adaptive phase plan at Farmgate', status: 'Completed', actorName: 'System Seed', details: { cycleSeconds: 120 }, createdAt: new Date(Date.now() - 600000).toISOString() }
];
